...
public class Lab015 {
    ...
    public void testxpath() throws InterruptedException {
      ...
      //  WebElement btnElement_ID = driver.findElement(By.id("btn-make-appointment"));
       // WebElement btnElement_class = driver.findElement(By.className("btn-lg"));
       // btnElement_class.click();
        //WebElement btnElement_PTXL = driver.findElement(By.partialLinkText("Make Appointment"));
        WebElement btnElement_XP = driver.findElement(By.xpath("//a[@href='./profile.php#login']"));
        btnElement_XP.click();
        ...
        username_element.get(1).sendKeys("Prachi Yelkar");

        WebElement enterpassword = driver.findElement(By.id("txt-password"));
        enterpassword.sendKeys("prachi@123");
